...
const PolicyModalManager = {
    ...
    _sanitizePolicyContent(html) {
        ...
        return sanitizer.sanitizeHtml(html, {
            allowedTags: ['h2', 'p', 'ul', 'ol', 'li', 'strong', 'em', 'a', 'br'],
    ...
    _updateBackButton() {
        ...
        // - есть предыдущий документ в истории политик (currentIndex > 0)
        // - ИЛИ текущий документ первый, но есть родительская модалка (т.е. политика открыта поверх другой модалки)
