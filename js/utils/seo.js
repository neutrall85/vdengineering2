...
const seoDatabase = {
  ...
  page: {
    'about': {
      ...
      description: 'ООО "Волга-Днепр Инжиниринг" — 7+ лет опыта, 100+ проектов. Разработка и сертификация модификаций авиационной техники, двигателей и компонентов. Узнайте больше о компании.',
      canonical: 'https://vdengineering.ru/about'
    },
    'contacts': {
      title: 'Контакты | Свяжитесь с нами – ООО "Волга-Днепр Инжиниринг"',
    ...
    'partners': {
      title: 'Партнёры и клиенты | ООО "Волга-Днепр Инжиниринг"',
    ...
    'vacancies': {
      ...
      description: 'Актуальные вакансии в ООО "Волга-Днепр Инжиниринг". Работа в сфере авиационного инжиниринга. Присоединяйтесь к команде профессионалов!',
      canonical: 'https://vdengineering.ru/vacancies'
    },
    'docs': {
      title: 'Документы | Сертификаты и лицензии ООО «Волга-Днепр Инжиниринг»',
