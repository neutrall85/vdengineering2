...
<p>Ваш запрос на коммерческое предложение зарегистрирован и передан в коммерческую службу. Специалист свяжется с вами в течение <strong>1 рабочего дня</strong> для уточнения деталей и подготовки предложения.</p>
<p>Если вопрос срочный — просто ответьте на это письмо, мы увидим его в первую очередь.</p>
<p>С уважением,<br>Коммерческая служба<br>$companyEsc</p>";

        $text = "Запрос получен\n\n"
            . "Уважаемый(ая) $clientName,\n\n"
            . "Благодарим вас за обращение в $companyRaw.\n\n"
            . "Ваш запрос на коммерческое предложение зарегистрирован и передан в коммерческую службу. Специалист свяжется с вами в течение 1 рабочего дня для уточнения деталей и подготовки предложения.\n\n"
...
<p>Ваше резюме передано HR-специалисту. Если ваш опыт и компетенции соответствуют требованиям вакансии, мы свяжемся с вами в течение <strong>5 рабочих дней</strong> для обсуждения дальнейших шагов.</p>
...
<p>С уважением,<br>Служба управления персоналом<br>$companyEsc</p>";

        $text = "Отклик получен\n\n"
            . "Уважаемый(ая) $clientName,\n\n"
            . $vacancyText
            . "Благодарим вас за интерес к работе в $companyRaw.\n\n"
            . "Ваше резюме передано HR-специалисту. Если ваш опыт и компетенции соответствуют требованиям вакансии, мы свяжемся с вами в течение 5 рабочих дней для обсуждения дальнейших шагов.\n\n"
...
<p>Уважаемый(ая) $clientName,</p>
<p>Благодарим вас за интерес к работе в <strong>$companyEsc</strong>.</p>
<p>Ваше резюме получено и передано в службу управления персоналом. Мы рассмотрим его в рамках актуальных и будущих вакансий компании.</p>
<p>Если ваш опыт и компетенции будут соответствовать нашим потребностям, мы свяжемся с вами.</p>
<p>Вы также можете отслеживать актуальные вакансии на нашем сайте.</p>
<p>С уважением,<br>Служба управления персоналом<br>$companyEsc</p>";

        $text = "Резюме получено\n\n"
            . "Уважаемый(ая) $clientName,\n\n"
            . "Благодарим вас за интерес к работе в $companyRaw.\n\n"
            . "Ваше резюме получено и передано в службу управления персоналом. Мы рассмотрим его в рамках актуальных и будущих вакансий компании.\n\n"
            . "Если ваш опыт и компетенции будут соответствовать нашим потребностям, мы свяжемся с вами.\n\n"
            . "Вы также можете отслеживать актуальные вакансии на нашем сайте.\n\n"
            . "С уважением,\nСлужба управления персоналом\n$companyRaw";
